...
class LabelDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'label.details.';
    ...
    const ReactComponent = React.createElement(LabelDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('label-details', LabelDetailsElement);
