...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/label/tableWidget/>):
   1. Run `npm i`
...
- **label.table.error** (fired when an error occurs)
- **label.table.select** (fired when a table row is selected)
