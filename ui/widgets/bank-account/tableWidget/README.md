...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/bankAccount/tableWidget/>):
   1. Run `npm i`
...
- **bankAccount.table.error** (fired when an error occurs)
- **bankAccount.table.select** (fired when a table row is selected)
