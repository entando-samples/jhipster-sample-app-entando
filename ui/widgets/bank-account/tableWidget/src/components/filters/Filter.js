      ...
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            ...
            <option value="active">{t('entities.bankAccount.active')}</option>
            <option value="accountType">{t('entities.bankAccount.accountType')}</option>
            <option value="attachment">{t('entities.bankAccount.attachment')}</option>
            <option value="description">{t('entities.bankAccount.description')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
