...
afterEach(() => {
  ...
  describe('Table widget', () => {
    ...
    it('should display all the entity fields in the component', () => {
        ...
        cy.contains('entities.bankAccount.lastOperationDuration').scrollIntoView().should('be.visible');
        cy.contains('entities.bankAccount.meanOperationDuration').scrollIntoView().should('be.visible');
