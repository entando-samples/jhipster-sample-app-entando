...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/bankAccount/formWidget/>):
   1. Run `npm i`
...
- **bankAccount.form.createError** (fired when an error occurs during bankAccount creation)
- **bankAccount.form.create** (fired when the bankAccount is successfully created)
- **bankAccount.form.updateError** (fired when an error occurs during bankAccount update)
- **bankAccount.form.update** (fired when the bankAccount is successfully updated)
