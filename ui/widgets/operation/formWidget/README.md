...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/operation/formWidget/>):
   1. Run `npm i`
...
- **operation.form.createError** (fired when an error occurs during operation creation)
- **operation.form.create** (fired when the operation is successfully created)
- **operation.form.updateError** (fired when an error occurs during operation update)
- **operation.form.update** (fired when the operation is successfully updated)
