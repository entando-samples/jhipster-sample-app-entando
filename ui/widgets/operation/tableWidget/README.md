...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/operation/tableWidget/>):
   1. Run `npm i`
...
- **operation.table.error** (fired when an error occurs)
- **operation.table.select** (fired when a table row is selected)
