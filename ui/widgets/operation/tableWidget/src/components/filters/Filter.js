    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="date">{t('entities.operation.date')}</option>
            <option value="description">{t('entities.operation.description')}</option>
            <option value="amount">{t('entities.operation.amount')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
